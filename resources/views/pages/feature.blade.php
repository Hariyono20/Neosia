<div id="feature" class="bg-[#12474D] text-white">
    ...
    <div
        ...
        <!-- Gambar -->
        <div class="h-[300px] md:h-[500px] w-full rounded-xl overflow-hidden bg-cover bg-center
                order-2 md:order-1 lg:col-span-3"
        ...
        <div class="order-1 md:order-2">
            ...
            <p class="mb-6 leading-relaxed">
                Neosia offers certified training programs designed by industry experts to help you gain practical
                skills, build strong portfolios, and grow your career in tech and engineering.
            </p>
            <a href="#"
                class="inline-block text-yellow-400 border border-yellow-400 px-5 py-2 rounded hover:bg-yellow-400 hover:text-[#12474D] transition font-medium">
                View All Courses
            </a>
        </div>

        <!-- Bagian 2 -->
        <div class="flex flex-col gap-6 order-3 md:order-3">
            <div>
                <div
                    class="w-16 h-16 flex items-center justify-center rounded-full bg-[#4F46E5] mb-4 transition-transform duration-300 hover:scale-110 hover:rotate-6">
        ...
        <!-- Bagian 3 -->
        <div class="flex flex-col gap-6 order-4 md:order-4">
            <div>
                <div
                    class="w-16 h-16 flex items-center justify-center rounded-full bg-[#4F46E5] mb-4 transition-transform duration-300 hover:scale-110 hover:rotate-6">
