    ...
    <div class="hidden md:flex justify-between items-center px-6 lg:px-20 py-3 border-t border-white/20">
        ...
        'Blog' => ['Artikel Terbaru' => '#', 'Tips & Trik' => '#'],
                ...
                <li class="relative group">
                    ...
                    <div
                        class="absolute left-0 mt-2 w-44 bg-white text-black rounded shadow z-50 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200">
        ...
        'Blog' => ['Artikel Terbaru' => '#', 'Tips & Trik' => '#'],
                ...
                <li>
                    ...
                    <ul class="ml-4 space-y-1 text-sm text-yellow-300">
                        @foreach ($submenus as $label => $link)
                            <li><a href="{{ $link }}"
                                    class="block hover:text-yellow-200">{{ $label }}</a></li>
                        @endforeach
                    </ul>
                </li>
            @endforeach
