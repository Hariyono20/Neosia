...
@php
    $products = [
        [
            ...
            'description' =>
                'Master the fundamentals of aerospace simulation, modeling, and structural design using industry-standard workflows.',
            'price' => 150000,
            'week' => 1,
            'rating' => 4.6,
        ],
...
<div class="flex gap-6 overflow-x-auto pb-4 sm:grid sm:grid-cols-2 lg:grid-cols-3 sm:gap-8 sm:overflow-visible"
    data-aos="fade-up" data-aos-delay="100">

    @foreach ($products as $product)
        <div
            class="bg-[#12474D] rounded-3xl shadow-lg p-6 flex-shrink-0 w-80 sm:w-auto 
                   flex flex-col justify-between text-white min-h-[500px] 
            ...
            <div class="flex-1">
                ...
                <!-- Grid Informasi -->
                <div class="grid grid-cols-3 divide-x divide-gray-600 text-center text-sm text-gray-200 pt-4">
                    <div class="px-2">
                        <div class="flex justify-center items-center gap-1">
                            <i class="fa-solid fa-dollar-sign"></i> <span>Price</span>
                        </div>
                        <div class="text-[#FFB71A] font-semibold mt-1">
